                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <c:forEach begin="1" end="5" step="1" var="ii">
                                    <option <c:if test='${ii == pageInfo.pageSize}'>selected</c:if>>${ii}</option>
                                </c:forEach>
                            </select> 条
                        </div>
                    </div>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <%--
                                                        <li <c:if test="${PageInfo.pageNum == pageNum}">class="active"</c:if>><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageNum}&size=${PageInfo.pageSize}">${pageNum}</a></li>
                            --%>
